  ...
  private responseData(comments: Comment[]): CommentResponse[] {
    return comments.map((comment) => {
      return {
        ...
        createdAt: String(comment.comment_date),
        createdDate: formatISODate(String(comment.comment_date)),
        createdTime: formatISOTime(String(comment.comment_date)) as string,
        createdAtGmt: String(comment.comment_date_gmt),
